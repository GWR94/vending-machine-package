...
public class ChangeDisplay {
    ...
    public static void display(Map<String, Integer> change, BigDecimal cost, BigDecimal coins) {

        Stage window = new Stage();
        window.initModality(Modality.APPLICATION_MODAL);
        window.setTitle("Change");
        Label amountLbl = new Label("£" + df.format(coins) + " inserted, with your items costing £" + df.format(cost) + "\nChange Due:");
        Label changeLbl = new Label();
        Label anotherLbl = new Label("Would you like to buy another item?");
        ...
        else if(changeLbl.getText().isEmpty()) {
            changeLbl.setText("No change due.\n");
        }
